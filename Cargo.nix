  ...
  internal = rec {
    ...
    crates = {
      ...
      "k8s-openapi" = rec {
        ...
        resolvedDefaultFeatures = [ "latest" "v1_31" ];
      };
      "kube" = rec {
        crateName = "kube";
        version = "0.97.0";
        edition = "2021";
        sha256 = "1bk7dirl6ha7hib164f8an8dc17i9720ffd49iw2z4lg8ab2bzg5";
        authors = [
        ...
        resolvedDefaultFeatures = [ "client" "config" "derive" "kube-client" "kube-derive" "kube-runtime" "runtime" "rustls-tls" "unstable-runtime" ];
      };
      "kube-client" = rec {
        crateName = "kube-client";
        version = "0.97.0";
        edition = "2021";
        sha256 = "16cxb0di3qn00pismbyxv3v2073a5fbvwqhpd6myaahn7m4vcffm";
        libName = "kube_client";
        authors = [
          "clux <sszynrae@gmail.com>"
          "Natalie Klestrup Röijezon <nat@nullable.se>"
      ...
      "kube-core" = rec {
        ...
        version = "0.97.0";
        edition = "2021";
        sha256 = "19ypym7pawwlcy4m4mwz4qlvms3f6sy1zbk3pcnbdxkc0k07ra4q";
        libName = "kube_core";
        authors = [
          "clux <sszynrae@gmail.com>"
          "Natalie Klestrup Röijezon <nat@nullable.se>"
      ...
      "kube-derive" = rec {
        ...
        version = "0.97.0";
        edition = "2021";
        sha256 = "1n5cssbbyx47h8mzqr7sj1dp45famm3jg3askfl58q9yf4i6jmv5";
        procMacro = true;
        libName = "kube_derive";
        authors = [
          "clux <sszynrae@gmail.com>"
      ...
      "kube-runtime" = rec {
        ...
        version = "0.97.0";
        edition = "2021";
        sha256 = "0gn44d8snqfxkq8lm4xq1b8ngdj1wnyr819hgzhhmgn9wv1qqd2g";
      ...
      "lava-dependency" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8ddacb10e9ea87b37842e1b6983240f965ca6514";
          sha256 = "0q3y9raskl9xab68w33x7z4d9bn7gr3pnznz6zv7fdz8db5hgbr9";
        };
      ...
      "lava-operator" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            usesDefaultFeatures = false;
            features = [ "runtime" "derive" "client" "rustls-tls" "unstable-runtime" ];
          }
          {
            name = "lava-anomaly";
            packageId = "lava-anomaly";
      ...
      "lava-outcome-chain" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "1l0rcg227cdy73xdfphbc8f6bxi3d72ychqgdk7x6s9v4s4wkmf2";
        };
      ...
      "lava-viggy" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "f224dc266b28bf7d1b632dde52c0d593ed9c8a31";
          sha256 = "17cbj4xa23n2xsh7gm985f1limg2k46zdbxirxh0fygg18f1l5l4";
        };
        libName = "lava_viggy";
        authors = [
          "pleme-io"
      ...
      "magma-lava" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "97054986da0788b0d030d8beb0d3526733088949";
          sha256 = "1mxb6a66a9pj4hca0wy1rcp47vb4cc9if2ha440yaz0pn1jmyhv2";
        };
        libName = "magma_lava";
        authors = [
          "pleme-io"
      ...
      "tower" = rec {
        ...
        resolvedDefaultFeatures = [ "buffer" "filter" "futures-core" "futures-util" "pin-project-lite" "sync_wrapper" "tokio" "tokio-util" "tracing" "util" ];
      };
      "tower-http" = rec {
